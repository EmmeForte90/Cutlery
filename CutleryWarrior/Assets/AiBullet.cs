...
public class AiBullet : MonoBehaviour
{
    ...
    private ForkSemple ch_FAc;
    private KnifeSample ch_KAc;
    private SpoonSemple ch_SAc;
    public int attackDamage = 5;
    public GameObject hitEffect;
    public bool Take = true;
    public void Awake()
    {
        ch_SAc = GameObject.Find("Enm_Spoon").GetComponent<SpoonSemple>();
        ch_FAc = GameObject.Find("Enm_Fork").GetComponent<ForkSemple>();
        ch_KAc = GameObject.Find("Enm_Knife").GetComponent<KnifeSample>();
        //
