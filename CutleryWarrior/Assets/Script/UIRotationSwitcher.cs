...
public class UIRotationSwitcher : MonoBehaviour
{
    ...
    private void SetColor1(Color color){skeletonGraphic1.color = color;}
    private void SetColor2(Color color){skeletonGraphic2.color = color;}
    private void SetColor3(Color color){skeletonGraphic3.color = color;}
    public void Update()
